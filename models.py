...
class Convi(nn.Module):
    def __init__(self):
        ...
        self.conv_1 = nn.Conv1d(in_channels = 4096, out_channels = 128, kernel_size = 1) 
        # normalize (reduces the covariation in outputs that get passed to next layer) 
        self.bn1 = nn.BatchNorm1d(128)


        # # do the same thing for next set of layers...
        # self.conv_2 = nn.Conv1d(in_channels = 32, out_channels = 64, kernel_size = 1) 
        # self.bn2 = nn.BatchNorm1d(64)

        # # aaaaand the next set...   
        # self.conv_3 = nn.Conv1d(in_channels = 64, out_channels = 128, kernel_size = 1) 
        # self.bn3 = nn.BatchNorm1d(128)

        # # fully connected layers
        # self.fc_1 = nn.Linear(in_features = 128, out_features = 64)
